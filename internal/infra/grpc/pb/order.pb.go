...
type CreateOrderResponseList struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	CreateOrderResponses []*CreateOrderResponse `protobuf:"bytes,1,rep,name=createOrderResponses,proto3" json:"createOrderResponses,omitempty"`
}

func (x *CreateOrderResponseList) Reset() {
	*x = CreateOrderResponseList{}
	if protoimpl.UnsafeEnabled {
...
func (x *CreateOrderResponseList) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*CreateOrderResponseList) ProtoMessage() {}

func (x *CreateOrderResponseList) ProtoReflect() protoreflect.Message {
	mi := &file_internal_infra_grpc_protofiles_order_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use CreateOrderResponseList.ProtoReflect.Descriptor instead.
func (*CreateOrderResponseList) Descriptor() ([]byte, []int) {
	return file_internal_infra_grpc_protofiles_order_proto_rawDescGZIP(), []int{2}
}

func (x *CreateOrderResponseList) GetCreateOrderResponses() []*CreateOrderResponse {
	if x != nil {
...
var file_internal_infra_grpc_protofiles_order_proto_rawDesc = []byte{
	...
	,
	...
	0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x4c, 0x0a, 0x11, 0x43, 0x72, 0x65, 0x61, 0x74,
	...
	0x4f, 0x72, 0x64, 0x65, 0x72, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x4c, 0x69, 0x73,
	0x74, 0x22, 0x00, 0x28, 0x01, 0x42, 0x18, 0x5a, 0x16, 0x69, 0x6e, 0x74, 0x65, 0x72, 0x6e, 0x61,
...
var file_internal_infra_grpc_protofiles_order_proto_goTypes = []interface{}{
	...
	(*CreateOrderResponseList)(nil), // 2: pb.CreateOrderResponseList
}
var file_internal_infra_grpc_protofiles_order_proto_depIdxs = []int32{
	1, // 0: pb.CreateOrderResponseList.createOrderResponses:type_name -> pb.CreateOrderResponse
	...
	2, // 4: pb.OrderService.CreateOrderStream:output_type -> pb.CreateOrderResponseList
...
func file_internal_infra_grpc_protofiles_order_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_internal_infra_grpc_protofiles_order_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*CreateOrderResponseList); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
