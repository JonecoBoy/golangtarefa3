...
var setOrderRepositoryDependency = wire.NewSet(wire.NewSet(database.NewOrderRepository), wire.Bind(new(entity.OrderRepositoryInterface), new(*database.OrderRepository)))

var setEventDispatcherDependency = wire.NewSet(wire.NewSet(events.NewEventDispatcher, event.NewOrderCreated), wire.Bind(new(events.EventInterface), new(*event.OrderCreated)), wire.Bind(new(events.EventDispatcherInterface), new(*events.EventDispatcher)))
